...
class _CustomTileState extends State<CustomTile> {
  _deleteDisease(BuildContext context) {
    Firestore.instance
        .collection('Penyakit')
        .document(widget.snapshot.data['Nama_Penyakit'])
        .delete();
    Navigator.push(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            Text(
              widget.snapshot.data['Name_Penyakit'],
...
class DeletingWait extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Future.delayed(Duration(seconds: 2), () {
      ...
      Toast.show("Berhasil Menghapus!", context, backgroundRadius: 5, backgroundColor: Colors.red, duration: 3);
    });
    return Scaffold(
      body: SafeArea(
        child: Container(
