...
import 'package:medkit/otherWidgetsAndScreen/Tentang.dart';
import 'package:medkit/otherWidgetsAndScreen/kategori.dart';
import 'package:medkit/patient/pasienLogin.dart';
import 'package:page_transition/page_transition.dart';

import 'animations/fadeAnimation.dart';

void main() => runApp(MedKitA());

class MedKitA extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: WelcomeScreen(),
      routes: {
        '/DokterLogin' : (context) => DokterLogin(),
        '/PasienLogin' : (context) => PasienLogin(),
          ...
          children: <Widget>[
            Positioned(
              ...
              child: FadeAnimation(
                ...
                Container(
                  width: width,
                  child: Image(image: AssetImage('assets/RS.png')),
                ),
              ),
            ),
            Align(
                    ...
                    Column(
                      children: <Widget>[
                        ...
                        FadeAnimation(
                            1,
                            Text(
                              'Klik untuk proses selanjutnya!', textAlign: TextAlign.center,
