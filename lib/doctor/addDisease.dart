  ...
  Widget build(BuildContext context) {
    ...
    addingDisease () {
      Firestore.instance
          ...
          .setData({
        'NamaPenyakit': controllerDisName.text,
        'NamaObat': controllerMedName.text,
        'WaktuObat': controllerMedDose.text,
        'DeskripsiObat': controllerDesc.text,
        'post' : widget.doctorName,
        'EmailDokter' : widget.doctorEmail
      });
      controllerClear();
      Toast.show('Berhasil Menambahkan!', context,
    ...
    final addBtn = Container(
        ...
        child: RaisedButton(
          onPressed: () {
              ...
              Toast.show("Bidang Kosong Ditemukan!", context, backgroundColor: Colors.red, backgroundRadius: 5, duration: 2);
          },
          color: Colors.white,
          shape: StadiumBorder(),
          child: Text(
